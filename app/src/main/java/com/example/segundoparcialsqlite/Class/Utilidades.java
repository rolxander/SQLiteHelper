...
public class Utilidades {
    ...
    public static final String CREAR_TABLA_PERSONA = "CREATE TABLE "+TABLA_USUARIO+"("+CAMPO_NOMBRE+" varchar(30),"+CAMPO_APELLIDO+" varchar(30), "+CAMPO_CU+" varchar(30) primary key, "+CAMPO_LATITUD+" varchar(30), "+CAMPO_LONGITUD+" varchar(30))";
